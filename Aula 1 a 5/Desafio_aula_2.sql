...
select count(*) as quantidade_pedidos_1997 from orders where order_date between '1997-01-01' and '1997-12-31'

-- 5. Obter os nomes de todas as pessoas de contato onde a pessoa é um gerente, em ordem alfabética
select * from customers where contact_title ilike '%manager%' order by contact_name
